...
<main id="main" class="wrap">
  ...
  <div class="reveal" style="margin-block-start: var(--space-l)">
    ...
    <noscript>
      <p class="caption"><a href="https://www.youtube.com/watch?v=REEL_ID" target="_blank" rel="noopener">Watch the reel on YouTube</a></p>
    </noscript>
  </div>
...
The alt is empty because the visually-hidden span already labels the button; a described poster would double-announce.

- [ ] **Step 2: Add the clip encoder for later use**
...
```bash
git add reel.html tools/encode-clips.sh assets/video/.gitkeep
